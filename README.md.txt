...
## Install
 ...
 - Clone the repository `git clone https://github.com/mah-hacker/Facebook-spambot`
 - Install requirements.txt `pip install -r requirements.txt`
 
 ## Run the bot

 - Run the bot `python fb-spambot.py`
1. Enter your username
2. Enter your password
3. Enter your Friends username....you can find their username in their profile(**don't use just name because the message may go to others**)
4. Spam message you want to send.
